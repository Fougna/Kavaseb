...
/**
 * @ORM\Entity(repositoryClass=StudioDevRepository::class)
 */
class StudioDev
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity=StudioJeu::class, inversedBy="developpeurs")
     */
    private $studio;

    /**
     * @ORM\ManyToMany(targetEntity=Jeu::class, inversedBy="developpeurs")
     */
    private $jeu;
