...
/**
 * @ORM\Entity(repositoryClass=DoubleurRepository::class)
 */
class Doubleur
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Personnalite::class, inversedBy="doubleurs")
     */
    private $personnalite;

    /**
     * @ORM\ManyToMany(targetEntity=Film::class, inversedBy="doubleurs")
     */
    private $film;

    /**
     * @ORM\ManyToMany(targetEntity=Serie::class, inversedBy="doubleurs")
     */
    private $serie;

    /**
     * @ORM\ManyToMany(targetEntity=Episode::class, inversedBy="doubleurs")
     */
    private $episode;

    /**
     * @ORM\ManyToMany(targetEntity=Jeu::class, inversedBy="doubleurs")
     */
    private $jeu;
    ...
    /**
     * @ORM\OneToMany(targetEntity=Role::class, mappedBy="doubleur")
     */
    private $roles;
    ...
    public function removeRole(Role $role): self
    {
        if ($this->roles->removeElement($role)) {
            ...
            if ($role->getDoubleur() === $this) {
                $role->setDoubleur(null);
            }
        }
