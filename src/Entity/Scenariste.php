...
class Scenariste
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Personnalite::class, inversedBy="scenaristes")
     */
    private $personnalite;

    /**
     * @ORM\ManyToMany(targetEntity=Film::class, inversedBy="scenaristes")
     */
    private $film;

    /**
     * @ORM\ManyToMany(targetEntity=Serie::class, inversedBy="scenaristes")
     */
    private $serie;

    /**
     * @ORM\ManyToMany(targetEntity=Episode::class, inversedBy="scenaristes")
     */
    private $episode;

    /**
     * @ORM\ManyToMany(targetEntity=Jeu::class, inversedBy="scenaristes")
     */
    private $jeu;
