...
/**
 * @ORM\Entity(repositoryClass=EditeurFrancaisRepository::class)
 */
class EditeurFrancais
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Personnalite::class, inversedBy="editeurFrancais")
     */
    private $personnalite;

    /**
     * @ORM\ManyToMany(targetEntity=Livre::class, inversedBy="editeurFrancais")
     */
    private $livre;
