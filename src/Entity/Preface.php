...
/**
 * @ORM\Entity(repositoryClass=PrefaceRepository::class)
 */
class Preface
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Personnalite::class, inversedBy="prefaces")
     */
    private $personnalite;

    /**
     * @ORM\ManyToMany(targetEntity=Livre::class, inversedBy="prefaces")
     */
    private $livre;
