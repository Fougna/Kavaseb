...
class Realisateur
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Personnalite::class, inversedBy="realisateurs")
     */
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Serie::class, inversedBy="realisateurs")
     */
    private $serie;

    /**
     * @ORM\ManyToMany(targetEntity=Episode::class, inversedBy="realisateurs")
     */
    private $episode;
