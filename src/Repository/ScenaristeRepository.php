...
/**
 * @extends ServiceEntityRepository<Scenariste>
 *
...
class ScenaristeRepository extends ServiceEntityRepository
{
    ...
    public function add(Scenariste $entity, bool $flush = false): void
    {
    ...
    public function remove(Scenariste $entity, bool $flush = false): void
    {
...
//    /**
//     * @return Scenariste[] Returns an array of Scenariste objects
//     */
...
//    public function findOneBySomeField($value): ?Scenariste
//    {
//        return $this->createQueryBuilder('s')
//            ->andWhere('s.exampleField = :val')
//            ->setParameter('val', $value)
